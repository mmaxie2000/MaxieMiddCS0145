...
black_cat="the black cat, Salem"

entranceHall = create_room("entranceHall", """You are in the grand entrance hall of a large building.
How did you get here? Also why is there a black cat in here?""")
entranceHall["items"].append(black_cat)
...
It's big and dark up here. That pesky cat is still here though... weird.""")
...
create_exit(attic2, "balcony", "A small door rattles in the wind. Salem, the black cat, meows")
